    ...
    <div className="border border-[#1A2035] bg-[#0B0F1C] rounded-lg overflow-hidden reveal">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-[#1A2035] flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <Icon className="h-4 w-4 text-[#AABFCF]" />
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex flex-col items-center gap-2 -mt-1">
            ...
            {extraInfo && (
              <div className="text-[11px] font-data text-[#AABFCF] space-y-0.5 leading-relaxed text-center">
                {extraInfo}
              </div>
            )}
          </div>
        ...
        {breakdown.length > 0 && (
          <div className="space-y-2.5 border-t border-[#1A2035] pt-3">
            <p className="text-[11px] font-data text-[#AABFCF] tracking-[0.2em] uppercase">Risk Factors</p>
                ...
                <span
                  className={`shrink-0 text-xs font-bold font-data px-1.5 py-0.5 rounded border ${
                    item.points >= 20
                      ...
                      : 'bg-[#1A2035] text-[#C8D6E2] border-[#1A2035]'
                  }`}
                >
                  +{item.points}
                </span>
